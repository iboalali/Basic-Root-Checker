...
@Preview(name = "Phone - Spanish", group = "Phone", showBackground = true, locale = "es", device = "spec:width=411dp,height=891dp")
...
@Preview(name = "7-inch Tablet - Spanish", group = "7-inch Tablet", showBackground = true, locale = "es", device = "spec:width=600dp,height=960dp,dpi=240")
...
@Preview(name = "10-inch Tablet - Spanish", group = "10-inch Tablet", showBackground = true, locale = "es", device = "spec:width=1280dp,height=800dp,dpi=240")
